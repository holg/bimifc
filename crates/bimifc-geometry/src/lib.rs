...
//! # BIMIFC Geometry Processing (Trait-Based)
//!
//! Efficient geometry processing for IFC models using trait-based architecture.
//! This crate uses the `EntityResolver` trait from `bimifc-model` for entity
...
//! - `EntityResolver`: Trait from bimifc-model for entity lookup
//! - `GeometrySource`: Trait from bimifc-model for geometry access
//!
//! ## Quick Start
//!
//! ```rust,ignore
