...
impl Mesh {
    ...
    /// Convert to bimifc-model MeshData format
    pub fn to_mesh_data(&self) -> bimifc_model::MeshData {
        bimifc_model::MeshData {
    ...
    /// Create from bimifc-model MeshData format
    pub fn from_mesh_data(data: &bimifc_model::MeshData) -> Self {
        Self {
